...
def generate_pdf(top_zones: gpd.GeoDataFrame):
    ...
    # Petite fonction pour colorer les lignes du tableau selon priority_score
    ...
    with PdfPages(PDF_PATH) as pdf:
        # --- Page 1: Title + explanation + table ---
        ...
        # --- Page 2: bar plot left + map right ---
        ...
        # --- Carte à droite avec basemap OSM ---
        ax_map = axs[1]
        # Convertir en EPSG:3857 pour contextily
    ...
    logger.info(f"PDF report saved locally at {PDF_PATH}")
# ========================= MAIN =========================
def main():
